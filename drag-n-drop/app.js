...
var makeDraggable = function makeDraggable(area, draggable) {
  var drag = (0, _core.map)(beginDrag(area, draggable), (0, _core.tap)(preventDefault, (0, _domEvent.mousedown)(draggable)));

  // A mouseup DOM event generates a stream event which is a
  // stream containing a DROP.
  var drop = (0, _core.map)(endDrag(draggable), (0, _domEvent.mouseup)(area));
  ...
  // dropped behavior.
  return (0, _core.switchLatest)((0, _core.merge)(drag, drop));
};
...
var beginDrag = function beginDrag(area, draggable) {
  return function (e) {
    ...
    return (0, _core.startWith)(eventToDragInfo(GRAB, draggable, e), (0, _core.map)(function (e) {
      return eventToDragInfo(DRAG, draggable, e, dragOffset);
    }, (0, _domEvent.mousemove)(area)));
  };
};

var endDrag = function endDrag(draggable) {
  return function (e) {
    return (0, _core.now)(eventToDragInfo(DROP, draggable, e));
  };
};
...
(0, _core.runEffects)((0, _core.tap)(handleDrag, makeDraggable(area, draggable)), (0, _scheduler.newDefaultScheduler)());
