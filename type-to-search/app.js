...
},{"@most/disposable":2,"@most/prelude":5,"@most/scheduler":6}],2:[function(require,module,exports){
(function (global, factory) {
...
},{"@most/prelude":5}],3:[function(require,module,exports){
(function (global, factory) {
...
},{"@most/scheduler":4}],4:[function(require,module,exports){
(function (process){
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@most/prelude')) :
	typeof define === 'function' && define.amd ? define(['exports', '@most/prelude'], factory) :
...
},{"@most/prelude":5,"_process":7}],5:[function(require,module,exports){
(function (global, factory) {
...
},{"@most/prelude":5,"_process":7}],7:[function(require,module,exports){
...
},{"./mime/type/application/x-www-form-urlencoded":11,"./util/mixin":12}],9:[function(require,module,exports){
/*
...
},{"../UrlBuilder":8,"../client":9,"../util/responsePromise":14}],11:[function(require,module,exports){
/*
 * Copyright 2012-2016 the original author or authors
 * @license MIT, see LICENSE.txt for details
 *
...
},{"./normalizeHeaderName":13}],15:[function(require,module,exports){
'use strict';
...
var searchText = (0, _core.multicast)((0, _core.skipRepeats)((0, _core.map)(function (e) {
  return e.target.value.trim();
}, (0, _domEvent.input)(search))));
...
var results = (0, _core.map)(function (results) {
  return results[1];
}, (0, _core.filter)(function (results) {
  return results.length > 1;
}, (0, _core.switchLatest)((0, _core.map)(_core.fromPromise, (0, _core.map)(getResults, (0, _core.debounce)(500, (0, _core.filter)(function (text) {
  return text.length > 1;
}, searchText)))))));

// Empty results list if there is no search term
var emptyResults = (0, _core.constant)([], (0, _core.filter)(function (text) {
  return text.length < 1;
}, searchText));

var updates = (0, _core.merge)(results, emptyResults);
...
// Render the results
(0, _core.runEffects)((0, _core.tap)(render, updates), (0, _scheduler.newDefaultScheduler)());

},{"@most/core":1,"@most/dom-event":3,"@most/scheduler":6,"rest/client/jsonp":10}]},{},[15]);
